...
var people = __webpack_require__(6); //自己定义的文件同路径下也要写路径
// console.log(people);
// console.log(people[0].name);
//cnpm install jquery --save-dev 命令行中输入
//引入第三方类库
var $ = __webpack_require__(7); //引入了它就可以使用jQuery
...
//这样写app。js中才能用require引入
// function worthless() {
// 	console.log("webpack is really good!")
// }
// module.exports = worthless();

var people = [{ name: "Herry1" }, { name: "Herry2" }, { name: "Herry3" }, { name: "Herry4" }, { name: "Herry7" }];
